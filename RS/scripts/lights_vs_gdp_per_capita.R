...
for(i in c("no sampling", "down", "up", "smote")){
  ...
  stratified_kfold <- createFolds(y = factor(gdp_lights$label_class), 
                                  k = 10, 
                                  returnTrain = TRUE)
  ...
  cv_fit <- train(as.data.frame(gdp_lights[, 1:5]), gdp_lights$label_class, 
                  method = "glmnet", 
                  family="binomial",
                  trControl = ctrl,
                  metric = "Accuracy",
...
for(i in c("no sampling", "down", "up", "smote")){
  ...
  stratified_kfold <- createFolds(y = factor(gdp_lights_scaled$label_class), 
                                  k = 10, 
                                  returnTrain = TRUE)
  ...
  cv_fit <- train(as.data.frame(gdp_lights_scaled[, 1:5]), gdp_lights_scaled$label_class, 
                  method = "glmnet", 
                  family="binomial",
                  trControl = ctrl,
                  metric = "Accuracy",
