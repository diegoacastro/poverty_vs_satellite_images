This document shows how to replicate the dissertation results is steps (some adjusts may be necessary due to changes in data files):
...
First, let us save files in the correct directory for Rio Grande do Sul:
...
Now, let us run the scripts to generate results for Rio Grande do Sul:
