...
try({
  ...
  data.table::fwrite(results_regression, "results/RS_using_BA_regression.csv")
  rm(results)
})
gc()
...
try({
  ...
  gc()
  data.table::fwrite(results_classification, "results/RS_using_BA_classification.csv")
})
